...
* **`check_system.py`** - Core Python automation script designed to capture real-time CPU, Memory, and critical OS infrastructure metrics.
* **`disk_check.py`** - Infrastructure monitoring script that tracks storage utilization and flags disk-space alerts.
* **`system_logs.txt`** - Production-style sample system logs used to test parsing and string manipulation logic.
